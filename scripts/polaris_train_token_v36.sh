#!/bin/bash
#SBATCH --job-name=bounce-token-model-v36
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=04:00:00
#SBATCH --output=bounce-token-model-v36-%j.log
...
# v36: control for v35: continue v33 for 3000 more batches at 40-step unrolls with --speed-weight 0.3.
...
python -m model.token_train \
  ...
  --checkpoint checkpoints/token_model_h44_v36.pt
