#!/bin/bash
#SBATCH --job-name=bounce-token-model-v31
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=04:00:00
#SBATCH --output=bounce-token-model-v31-%j.log
...
# v31: continue v30 (v25 fine-tuned at 40-step unrolls with --speed-weight 0.1) for another 1500 batches WITH --ball-split (overlap-resolving init detection); v32 is the same without it as the control.
...
python -m model.token_train \
  ...
  --checkpoint checkpoints/token_model_h44_v31.pt
