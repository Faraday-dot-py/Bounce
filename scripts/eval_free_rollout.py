...
def load_model(checkpoint, mode, n, hidden_dim, neighbor_radius):
    model = TokenModel(n=n, radius=0.75, dt=0.15, hidden_dim=hidden_dim, neighbor_radius=neighbor_radius,
                        free_rollout=mode == "free", track_query=mode == "v17",
...
def main():
    ...
    model = load_model(args.checkpoint, args.mode, args.n, args.hidden_dim, args.neighbor_radius)
