#!/bin/bash
#SBATCH --job-name=bounce-token-model-v40
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=04:00:00
#SBATCH --output=bounce-token-model-v40-%j.log
...
# v40: continue v30 (checkpoints/token_model_h44_v30.pt) for 3000 batches at 40-step unrolls with --contact-weight 3.0 and --speed-weight 0.3; part of a contact-weighted lineage soup (v40, v40, v41, v42).
...
python -m model.token_train \
  ...
  --checkpoint checkpoints/token_model_h44_v40.pt
