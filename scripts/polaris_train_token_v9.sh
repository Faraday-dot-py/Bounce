#!/bin/bash
#SBATCH --job-name=bounce-token-model-v9
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=01:00:00
#SBATCH --output=bounce-token-model-v9-%j.log
...
# Ablation vs v8: isolate token_state_loss by zeroing grid_weight and
# boundary_weight -- tests whether the state-space loss alone prevents
# the give-up-to-vanishing pattern (job 2851 showed it recurring with
# grid_weight/boundary_weight both nonzero). Same recipe otherwise for
