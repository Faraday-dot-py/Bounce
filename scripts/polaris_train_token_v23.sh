...
# v23: v22 (v21 + --wall-lookahead) plus --wall-head (separate two-layer wall-impulse head, TokenFreeDynamics). Wall-bounce diagnosis in docs/debugging/experiment-log.md.
