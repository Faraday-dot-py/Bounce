#!/bin/bash
#SBATCH --job-name=bounce-stage2-h12-fixed-200ep
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=02:30:00
#SBATCH --output=bounce-stage2-h12-fixed-200ep-%j.log
...
python -m model.train \
  ...
  --num-samples 1500 --batch-size 16 --epochs 200 \
  --embed-dim 128 --depth 6 --num-heads 4 --window-size 8 \
  --horizon 12 \
  --seed 4738 \
  --checkpoint checkpoints/stage2_h12_fixed_200ep.pt \
