#!/bin/bash
#SBATCH --job-name=bounce-token-model-v33
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=04:00:00
#SBATCH --output=bounce-token-model-v33-%j.log
...
# v33: continue v31 (v30 + ball-split fine-tune) for 3000 more batches at 40-step unrolls with --ball-split and --speed-weight 0.3 (v34: same with 0.1).
...
python -m model.token_train \
  ...
  --checkpoint checkpoints/token_model_h44_v33.pt
