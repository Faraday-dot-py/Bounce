#!/bin/bash
#SBATCH --job-name=bounce-token-model-v42
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=04:00:00
#SBATCH --output=bounce-token-model-v42-%j.log
...
# v42: continue v33 (checkpoints/token_model_h44_v33.pt) for 3000 batches at 40-step unrolls with --contact-weight 3.0 and --speed-weight 0.3; part of a contact-weighted lineage soup (v42, v40, v41, v42).
...
python -m model.token_train \
  ...
  --n 20 --horizon 44 \
  --free-rollout --stepwise-curriculum --curriculum-min-steps 40 --curriculum-max-steps 40 --init-checkpoint checkpoints/token_model_h44_v33.pt \
  ...
  --checkpoint checkpoints/token_model_h44_v42.pt
