#!/bin/bash
#SBATCH --job-name=bounce-token-model-v35
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=04:00:00
#SBATCH --output=bounce-token-model-v35-%j.log
...
# v35: continue v33 (v31 + 3000 batches, speed-weight 0.3) for 3000 more batches at 40-step unrolls with --speed-weight 1.0 (v36: same with 0.3).
...
python -m model.token_train \
  ...
  --velocity-readout --position-refine --ball-split --wall-lookahead --wall-head --pair-impulse --speed-weight 1.0 --lr 3e-4 \
  --seed 4738 --log-every 0 \
  --checkpoint checkpoints/token_model_h44_v35.pt
