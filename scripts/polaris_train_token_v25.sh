#!/bin/bash
#SBATCH --job-name=bounce-token-model-v25
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=04:00:00
#SBATCH --output=bounce-token-model-v25-%j.log
...
# v25: all options -- v19 curriculum + --velocity-readout --position-refine (model/token_refine.py) --wall-lookahead --wall-head --pair-impulse.
...
python -m model.token_train \
  ...
  --checkpoint checkpoints/token_model_h24_v25.pt
