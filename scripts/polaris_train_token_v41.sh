#!/bin/bash
#SBATCH --job-name=bounce-token-model-v41
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=04:00:00
#SBATCH --output=bounce-token-model-v41-%j.log
...
# v41: continue v31 (checkpoints/token_model_h44_v31.pt) for 3000 batches at 40-step unrolls with --contact-weight 3.0 and --speed-weight 0.3; part of a contact-weighted lineage soup (v41, v40, v41, v42).
...
python -m model.token_train \
  ...
  --checkpoint checkpoints/token_model_h44_v41.pt
