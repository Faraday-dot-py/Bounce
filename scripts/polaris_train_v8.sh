#!/bin/bash
#SBATCH --job-name=bounce-stage2-flownet-v8
#SBATCH --partition=gpu
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --time=02:30:00
#SBATCH --output=bounce-stage2-flownet-v8-%j.log
...
python -m model.train \
  ...
  --horizon 12 \
  --peak-weight 0.1 \
  --mass-weight 0.1 --mass-tile 16 \
  --seed 4738 \
  --checkpoint checkpoints/stage2_flownet_h12_v8.pt \
